...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link changer.nl.polypicker.utils.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link changer.nl.polypicker.utils.AsyncTask.Status#RUNNING} or {@link changer.nl.polypicker.utils.AsyncTask.Status#FINISHED}.
     *
    ...
    private static class AsyncTaskResult<Data> {
        ...
        AsyncTaskResult(aubry.chromio.com.dressup.ImageLoaderUtils.AsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
